...
//        keyPairGenerator.initialize(KEYSIZE, secureRandom);
    ...
    public static void main(String[] args) throws Exception {
        String source = "张彤,321012PDY100328,江都妇幼保健院,127.0.0.1,test,123456,619CADB7FD744A83ADE219C4B30FB911,";// 要加密的字符串   docName/orgCode/orgName/ip/userName/password/residentId/ip
