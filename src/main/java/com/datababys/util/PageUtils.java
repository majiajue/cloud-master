 ...
 * Filename:		net.hp.es.adm.healthcare.rphcp.util.dwz.SpringDataJpaPageConvert.java
...
public class PageUtils {
	 ...
	 * @return
	 */
	public static Pageable createPageable(DTPager page) {
		return new PageRequest(page.getStart()/page.getLength(), page.getLength());
	}
